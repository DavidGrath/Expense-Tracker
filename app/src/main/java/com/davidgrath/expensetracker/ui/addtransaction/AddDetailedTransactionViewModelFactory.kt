...
class AddDetailedTransactionViewModelFactory(
    ...
    override fun <T : ViewModel> create(modelClass: Class<T>): T {
        return AddDetailedTransactionViewModel(application, mode, addDetailedTransactionRepository, categoryRepository, transactionId, initialAmount, initialDescription, initialCategoryId) as T
    }
}