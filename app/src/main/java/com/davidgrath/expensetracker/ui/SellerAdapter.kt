 ...
 */
class SellerAdapter(context: Context, var _objects: MutableList<SellerUi>): ArrayAdapter<SellerUi>(context, android.R.layout.simple_spinner_item, _objects) {
    ...
    fun setItems(sellers: List<SellerUi>) {
        this._objects.clear()
        this._objects.addAll(sellers)
