...
abstract class ExpenseTrackerDatabase: RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_2_3 = object: Migration(2, 3) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE CategoryDb ADD COLUMN `icon` TEXT NOT NULL DEFAULT 'materialsymbols:category'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:restaurant' WHERE stringId='food'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:home' WHERE stringId='rent'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:construction' WHERE stringId='utilities'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:directions_car' WHERE stringId='transportation'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:medical_services' WHERE stringId='healthcare'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:credit_card' WHERE stringId='debt'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:child_care' WHERE stringId='childcare'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:household_supplies' WHERE stringId='household'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:tv' WHERE stringId='entertainment'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:self_care' WHERE stringId='self_care'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:checkroom' WHERE stringId='clothing'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:book' WHERE stringId='education'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:featured_seasonal_and_gifts' WHERE stringId='gifts_and_donations'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:emergency' WHERE stringId='emergency'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:savings' WHERE stringId='savings'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:fitness_center' WHERE stringId='fitness'")
                db.execSQL("UPDATE CategoryDb SET icon='materialsymbols:category' WHERE stringId='miscellaneous'")
            }
        }
        @Volatile
