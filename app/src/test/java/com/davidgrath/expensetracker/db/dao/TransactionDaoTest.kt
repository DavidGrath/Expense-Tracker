...
class TransactionDaoTest {
    ...
    fun sumByDateTest() {
        ...
        val sums = transactionDao.getTransactionSumByDate(true, firstTransactionDate.toString(), null, true, emptyList(), true, emptyList(), true, emptyList()).blockingFirst()
        ...
        val boundSums = transactionDao.getTransactionSumByDate(true, firstTransactionDate.toString(), fourthTransactionDate.toString(), true, emptyList(), true, emptyList(), true, emptyList()).blockingFirst()
    ...
    fun totalSpentTest() {
        ...
        val firstSum = transactionDao.getTransactionDebitSum(firstTransactionDate.toString(), null, true, emptyList(), true, emptyList(), true, emptyList()).blockingFirst()

        assertEquals(0, BigDecimal(2610.00).compareTo(firstSum))

        val secondSum = transactionDao.getTransactionDebitSum(firstTransactionDate.toString(), fourthTransactionDate.toString(), true, emptyList(), true, emptyList(), true, emptyList()).blockingFirst()
